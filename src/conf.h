...
/* $Id: conf.h 1241 2007-06-24 04:13:13Z benoitg $ */
/** @file conf.h
...
#define DEFAULT_IPTABLES "/usr/sbin/iptables"
/*@}*/ 
...
typedef struct _firewall_rule_t {
    ...
    int direction;              /**< @brief 1 = from, 0 = to */
...
/**
 * Owner Trusted MAC Addresses
 */
typedef struct _owner_mac_t {
    char   *mac;
    struct _owner_mac_t *next;
} t_owner_mac;

/**
 * Interfaces List
 */
typedef struct _gateway_interface_t {
    char   *interface;
    struct _gateway_interface_t *next;
} t_gateway_interface;
...
typedef struct {
    ...
    char *gw_id;		/**< @brief ID of the Gateway, sent to central
				     server */
    t_gateway_interface *gw_interface;		/**< @brief Interfaces list we will accept connections on */
    ...
    t_owner_mac *ownermaclist; /**< @brief list of owner trusted macs */
...
void parse_owner_mac_list(char *);
void parse_gateway_interface(char *);
